  ...
  return (
    <main className="grid gap-4">
      ...
      <section className="rounded-[30px] bg-white/85 p-5 text-lg font-bold leading-relaxed shadow-soft">
        <p>Tap one object in Your Guess, then tap another object to swap their positions. Submit the arrangement when you want a clue.</p>
        <p className="mt-3">Use Last Result to compare totals. The game never marks which individual positions are correct.</p>
      </section>
    </main>
  );
}
